...
export default function CircuitAnim() {
	...
	useEffect(() => {
		setIsLoaded(true);
		if (svgRef.current) {
			const paths = svgRef.current.querySelectorAll<SVGPathElement>(".st0");
			paths.forEach((path) => {
				const length = path.getTotalLength();
				path.style.transition = "none";
				path.style.strokeDasharray = `${length} ${length}`;
				path.style.strokeDashoffset = `${length}`;
				path.getBoundingClientRect(); // Triggers a reflow
	...
	return (
		<svg
			...
			className={`min-w-[100%] min-h-[100%] relative transition-opacity duration-700 ${
		...
		>
			<g id="lines">
				...
				/>
				<polyline className="st0" points="868.2,0.2 761.5,73.7 761.5,81   " />
				<path className="st0" d="M876.3,0.2c0,0-104.3,71.8-97.1,67.5" />
				<line className="st0" x1="885" y1="0.2" x2="803.7" y2="57.7" />
				<polyline
					className="st0"
				...
				/>
				<polyline className="st0" points="927.3,0.3 779.5,103 779.5,111   " />
				<polyline
					className="st0"
				...
				/>
				<polyline className="st0" points="811.5,111 811.5,88 939,0.3  " />
				<polyline className="st0" points="823.5,107 823.5,103 960,7.7   " />
				<polyline className="st0" points="960.2,13.7 832.5,102.8 832.5,107  " />
				<line className="st0" x1="960" y1="21" x2="844.3" y2="102.8" />
				<polyline
					className="st0"
				...
				/>
				<line className="st0" x1="959.6" y1="81" x2="857" y2="151" />
				<polyline className="st0" points="959.9,92.5 730.3,253.5 670,253.5  " />
				<polyline
					className="st0"
				...
				/>
				<polyline className="st0" points="685.2,282.8 698,291.5 960,291.5   " />
				<polyline
					className="st0"
				...
				/>
				<line className="st0" x1="772" y1="331.5" x2="876" y2="331.5" />
				<polyline
					className="st0"
				...
				/>
				<line className="st0" x1="789" y1="343.5" x2="868" y2="343.5" />
				<polyline
					className="st0"
				...
				/>
				<polyline className="st0" points="738.2,379 743.5,382.5 960,382.5   " />
				<line className="st0" x1="879" y1="378.5" x2="960" y2="378.5" />
				<polyline
					className="st0"
					points="886,371.5 904,371.5 908.3,374.8 959.6,374.5   "
				/>
				<line className="st0" x1="919" y1="369.5" x2="960" y2="369.5" />
				<polyline className="st0" points="943.5,362 943.5,357 960,355.5   " />
				<polyline
					className="st0"
				...
				/>
				<path className="st0" d="M960,394.3" />
				<polyline className="st0" points="716.2,388.9 724,392.5 960,392.5   " />
				<line className="st0" x1="700" y1="396.5" x2="960" y2="396.5" />
				<polyline className="st0" points="726.9,404 730.3,399.5 960,399.5   " />
				<polyline
					className="st0"
				...
				/>
				<polyline className="st0" points="862,446 868,448.5 960,448.5   " />
				<line className="st0" x1="876" y1="442.5" x2="960" y2="442.5" />
				<polyline
					className="st0"
				...
				/>
				<polyline className="st0" points="954,227.5 959,227.5 960,227.5   " />
				<line className="st0" x1="870" y1="241.5" x2="960" y2="241.5" />
				<polyline
					className="st0"
					points="875,249.5 946,249.5 950,254.5 960,254.5   "
				/>
				<line className="st0" x1="954" y1="245.5" x2="960" y2="245.5" />
				<polyline className="st0" points="803.7,269.5 809,272.5 919,272.5   " />
				<polyline
					className="st0"
				...
				/>
				<polyline className="st0" points="748.5,496 749,533.5 788.8,560.2   " />
				<polyline
					className="st0"
					points="760.5,501 760.5,528 782.5,542.5 830,542.5 834.5,545.8 834.5,555 828.5,557.4 828.5,560   "
				/>
				<polyline className="st0" points="794.1,504 807,513.5 828,513.5   " />
				<polyline
					className="st0"
				...
				/>
				<polyline className="st0" points="488,399.4 494.5,404 494.5,560   " />
				<line className="st0" x1="485.5" y1="421" x2="485.5" y2="557" />
				<polyline
					className="st0"
					points="485.2,409.4 477.5,415.5 477.5,431 472.5,434.5 472.5,560   "
				/>
				<line className="st0" x1="465.5" y1="438" x2="465.5" y2="560" />
				<polyline
					className="st0"
				...
				/>
				<polyline className="st0" points="437.5,421 437.5,528 415,542.5   " />
				<polyline
					className="st0"
				...
				/>
				<line className="st0" x1="307" y1="551.2" x2="323.5" y2="539.5" />
				<polyline
					className="st0"
				...
				/>
				<polyline className="st0" points="93,560 86,554.5 0,554.2   " />
				<polyline className="st0" points="0,539.5 108,539.5 259,434.5   " />
				<polyline
					className="st0"
					points="255.2,419.5 242.5,428.5 242.5,440 107,533.5 0,536.4   "
				/>
				<path className="st0" d="M57.5,528.1c2,0.9,46,0,46,0l124.2-85.6" />
				<polyline className="st0" points="164.5,473 164.5,480 100.5,524   " />
				<polyline
					className="st0"
					points="81.5,522 81.5,511 105.5,496 105.5,489   "
				/>
				<polyline className="st0" points="138.5,480 138.5,485 103,511.2   " />
				<polyline
					className="st0"
					points="105.5,471.5 96.5,469.8 81.5,481.5 81.5,489  "
				/>
				<polyline className="st0" points="84,495.6 120.8,469.5 132,469.5  " />
				<polyline
					className="st0"
    ...
    276.5,387.7   "
				...
				/>
				<line className="st0" x1="1" y1="399.5" x2="10" y2="399.5" />
				<polyline
					className="st0"
    ...
    302.5,221 302.5,203 299,198.5 285,198.5 280.3,194.7   "
				...
				/>
				<polyline className="st0" points="86.3,276.7 120.8,253.3 122,247.7  " />
				<polyline className="st0" points="135.3,249 135.2,253.7 99,280  " />
				<polyline
					className="st0"
					points="81,299.5 47,299.5 26.5,314.7 26.5,347 21,351.4 8,351.7 2.7,347.1 0,345.5  "
				/>
				<polyline className="st0" points="0,337.5 5,337.5 13.3,342.7  " />
				<polyline
					className="st0"
    ...
    "
				...
				/>
				<path className="st0" d="M159,186.5" />
				<polyline
					className="st0"
				...
				/>
				<path className="st0" d="M93.5,179c3.2-0.3,41.8,0,41.8,0l7.3,4" />
				<polyline
					className="st0"
				...
				<path
					className="st0"
					d="M0,175.5h16c0,0,13.7-9.3,16.3-10.8s180.6,0,180.6,0l9.6,5.1v6.2l5,2.5"
				/>
				<polyline
					className="st0"
    ...
    8,151.5 3,155.3 -0.5,155  "
				/>
				<path className="st0" d="M0.6,137.6c2.1,0,260.8,0,260.8,0l14.9-9.6" />
				<polyline
					className="st0"
				...
				/>
				<polyline className="st0" points="-0.1,145.8 4,142.5 232,142.5  " />
				<polyline
					className="st0"
    ...
    c0.5,0.1,0.8,0.2,1.3,0.1s0.8-0.2,1.2-0.5c0.3-0.3,0.6-1.2,0.6-1.2V1"
				...
				/>
				<polyline className="st0" points="110.6,0.2 99,8.5 12,8.5   " />
				<polyline className="st0" points="15.8,0.7 21.7,4.5 92,4.5 97,0   " />
				<polyline
					className="st0"
    ...
    "
				/>
				<line className="st0" x1="430.5" y1="0" x2="430.5" y2="65" />
				<polyline
					className="st0"
					points="435.5,0 435.5,65 439.5,67.5 440,88.5  "
				/>
				<polyline className="st0" points="441.5,0 441.5,65 445.7,67.5   " />
				<polyline
					className="st0"
    ...
    475,51.1 474.7,-0.1   "
				...
				/>
				<polyline className="st0" points="504.5,82 504.5,95 510.5,97.6  " />
				<polyline
					className="st0"
    ...
    "
				...
				<path
					className="st0"
					d="M593.4,142.2c0,0-6.9-2.7-6.9-4.1c0-1.4,0-31.1,0-31.1l19-12.5H654l3,3.1"
				/>
				<polyline className="st0" points="650.5,110 650.5,132 633,144.2   " />
				<polyline
					className="st0"
    ...
    c0.7,0.4,2.2,1.8,2.2,1.8v17l8,7v15"
				...
				/>
				<polyline className="st0" points="727.5,168 727.5,59 810.7,0  " />
				<polyline
					className="st0"
    ...
    c0.7-0.2,1.3-0.7,1.6-0.9S292,0,292,0"
      ...
      "
				/>
				<path className="st0" d="M301.5,65.2" />
				<path className="st0" d="M301.2,0" />
				<path
					className="st0"
    ...
    c0.3,1,1.5,1.3,1.7,1.3c0.9,0.2,1.7-0.1,2.2-0.3c0.5-0.2,1-0.5,1.3-1.2c0.6-1-0.2-2.2-0.2-2.3V136l9.5-6.2l18,0.2"
				...
				/>
				<polyline className="st0" points="824.5,94.8 824.7,89.3 952.5,0   " />
				<line className="st0" x1="960" y1="1.5" x2="834.5" y2="89.2" />
				<line className="st0" x1="800.5" y1="113" x2="800.5" y2="162" />
				<path
					className="st0"
    ...
    186,381.5   "
				/>
				<path className="st0" d="M184.3,391" />
				<path
					className="st0"
    ...
    290,190.4 267.1,174 235.2,173.8 217.4,161.6 33.8,161.5 29,161.5 15.8,171 0,171.2  "
				/>
				<line className="st0" x1="960" y1="235" x2="867" y2="235.5" />
				<polyline
					className="st0"
			...
			<g id="Circles">
				...
				<circle className="st1" cx="262.5" cy="206.5" r="2.8" />
				<circle className="st1" cx="263" cy="186" r="2.8" />
				<circle className="st1" cx="245" cy="193.5" r="2.8" />
				...
				<circle className="st1" cx="308" cy="136" r="2.8" />
				<circle className="st1" cx="306.7" cy="148.5" r="2.8" />
				<circle className="st1" cx="296" cy="183" r="2.8" />
				...
				<circle className="st1" cx="225" cy="269" r="2.8" />
				...
				<circle className="st1" cx="290.8" cy="373.5" r="2.8" />
				...
				<circle className="st1" cx="293.5" cy="361" r="2.8" />
